...
#define CUSTOM_MACHINE_NAME "Simba Predator"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 415.0 }
...
#define Z_PROBE_FEEDRATE_FAST (200*40)
